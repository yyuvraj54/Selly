          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Text('Sign up',
                  style: TextStyle(fontSize: screenHeight * 0.03, fontWeight: FontWeight.bold,fontFamily: "Poppins"),
                ),
              ),
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: commonInputDecoration(labelText:"Username"),
              ...
              Container(
                margin: EdgeInsets.only(top: screenHeight * 0.02),
                child: TextFormField(controller: passwordController,style:commonTextsStyle(),obscureText: true,
              ...
              Container(
                ...
                child: MyElevatedButton(
                    ...
                    child: Text('SIGN UP',style: commonTextsStyle(color: Colors.white)),

                    onPressed: () {
                      print(usernameController.toString());
                      signupNow(nameController.toString(), usernameController.toString(), passwordController.toString(), phoneController.toString());}
                ),
              ),
              ...
              Container(
                margin: EdgeInsets.only(top: screenHeight * 0.02),
                child: Column(
                  children: [ Text('Or'), SizedBox(height: 8.0),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Already have an account",style: commonTextsStyle(fontsize: 15.0),), SizedBox(width: 8.0), GestureDetector(
